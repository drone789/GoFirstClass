"".T.M1 STEXT size=16 args=0x18 locals=0x0 funcid=0x0 align=0x0 leaf
	0x0000 00000 (main.go:12)	TEXT	"".T.M1(SB), LEAF|NOFRAME|ABIInternal, $0-24
	...
	0x0000 00000 (main.go:12)	FUNCDATA	$5, "".T.M1.arginfo1(SB)
	0x0000 00000 (main.go:12)	RET	(R30)
	0x0000 c0 03 5f d6 00 00 00 00 00 00 00 00 00 00 00 00  .._.............
"".T.M2 STEXT size=16 args=0x18 locals=0x0 funcid=0x0 align=0x0 leaf
	0x0000 00000 (main.go:13)	TEXT	"".T.M2(SB), LEAF|NOFRAME|ABIInternal, $0-24
	0x0000 00000 (main.go:13)	FUNCDATA	ZR, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x0000 00000 (main.go:13)	FUNCDATA	$1, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x0000 00000 (main.go:13)	FUNCDATA	$5, "".T.M2.arginfo1(SB)
	0x0000 00000 (main.go:13)	RET	(R30)
	0x0000 c0 03 5f d6 00 00 00 00 00 00 00 00 00 00 00 00  .._.............
"".main STEXT size=272 args=0x0 locals=0x78 funcid=0x0 align=0x0
	0x0000 00000 (main.go:20)	TEXT	"".main(SB), ABIInternal, $128-0
	0x0000 00000 (main.go:20)	MOVD	16(g), R16
	0x0004 00004 (main.go:20)	PCDATA	$0, $-2
	0x0004 00004 (main.go:20)	MOVD	RSP, R17
	0x0008 00008 (main.go:20)	CMP	R16, R17
	0x000c 00012 (main.go:20)	BLS	260
	0x0010 00016 (main.go:20)	PCDATA	$0, $-1
	0x0010 00016 (main.go:20)	MOVD.W	R30, -128(RSP)
	0x0014 00020 (main.go:20)	MOVD	R29, -8(RSP)
	0x0018 00024 (main.go:20)	SUB	$8, RSP, R29
	0x001c 00028 (main.go:20)	FUNCDATA	ZR, gclocals·7d2d5fca80364273fb07d5820a76fef4(SB)
	0x001c 00028 (main.go:20)	FUNCDATA	$1, gclocals·c73a1255c0cd89e7a2b21dfb392a7db1(SB)
	0x001c 00028 (main.go:20)	FUNCDATA	$2, "".main.stkobj(SB)
	0x001c 00028 (main.go:26)	MOVD	$17, R2
	0x0020 00032 (main.go:26)	MOVD	R2, ""..autotmp_13-24(SP)
	0x0024 00036 (main.go:26)	MOVD	$go.string."hello, interface"(SB), R3
	0x002c 00044 (main.go:26)	MOVD	R3, ""..autotmp_13-16(SP)
	0x0030 00048 (main.go:26)	MOVD	$16, R4
	0x0034 00052 (main.go:26)	MOVD	R4, ""..autotmp_13-8(SP)
	0x0038 00056 (main.go:26)	MOVD	$type."".T(SB), R0
	0x0040 00064 (main.go:26)	MOVD	$""..autotmp_13-24(SP), R1
	0x0044 00068 (main.go:26)	PCDATA	$1, ZR
	0x0044 00068 (main.go:26)	CALL	runtime.convT(SB)
	0x0048 00072 (main.go:26)	MOVD	R0, ""..autotmp_38-64(SP)
	0x004c 00076 (main.go:29)	MOVD	$17, R2
	0x0050 00080 (main.go:29)	MOVD	R2, ""..autotmp_13-24(SP)
	0x0054 00084 (main.go:29)	MOVD	$go.string."hello, interface"(SB), R2
	0x005c 00092 (main.go:29)	MOVD	R2, ""..autotmp_13-16(SP)
	0x0060 00096 (main.go:29)	MOVD	$16, R2
	0x0064 00100 (main.go:29)	MOVD	R2, ""..autotmp_13-8(SP)
	0x0068 00104 (main.go:29)	MOVD	$""..autotmp_13-24(SP), R1
	0x006c 00108 (main.go:29)	MOVD	$type."".T(SB), R0
	0x0074 00116 (main.go:29)	PCDATA	$1, $1
	0x0074 00116 (main.go:29)	CALL	runtime.convT(SB)
	0x0078 00120 (main.go:29)	MOVD	R0, ""..autotmp_39-72(SP)
	0x007c 00124 (main.go:31)	STP	(ZR, ZR), ""..autotmp_19-40(SP)
	0x0080 00128 (main.go:31)	MOVD	$type."".T(SB), R2
	0x0088 00136 (main.go:31)	MOVD	R2, ""..autotmp_19-40(SP)
	0x008c 00140 (main.go:31)	MOVD	""..autotmp_38-64(SP), R2
	0x0090 00144 (main.go:31)	MOVD	R2, ""..autotmp_19-32(SP)
	...
	0x00b8 00184 (main.go:32)	STP	(ZR, ZR), ""..autotmp_21-56(SP)
	0x00bc 00188 (main.go:32)	PCDATA	$0, $-4
	0x00bc 00188 (main.go:32)	MOVD	go.itab."".T,"".NonEmptyInterface+8(SB), R2
	0x00c8 00200 (main.go:32)	PCDATA	$0, $-1
	0x00c8 00200 (main.go:32)	MOVD	R2, ""..autotmp_21-56(SP)
	0x00cc 00204 (main.go:32)	MOVD	""..autotmp_39-72(SP), R2
	0x00d0 00208 (main.go:32)	MOVD	R2, ""..autotmp_21-48(SP)
	...
	0x00f8 00248 (main.go:33)	MOVD	-8(RSP), R29
	0x00fc 00252 (main.go:33)	MOVD.P	128(RSP), R30
	0x0100 00256 (main.go:33)	RET	(R30)
	0x0104 00260 (main.go:33)	NOP
	0x0104 00260 (main.go:20)	PCDATA	$1, $-1
	0x0104 00260 (main.go:20)	PCDATA	$0, $-2
	0x0104 00260 (main.go:20)	MOVD	R30, R3
	0x0108 00264 (main.go:20)	CALL	runtime.morestack_noctxt(SB)
	0x010c 00268 (main.go:20)	PCDATA	$0, $-1
	0x010c 00268 (main.go:20)	JMP	0
...
"".(*T).M1 STEXT dupok size=112 args=0x8 locals=0x8 funcid=0x15 align=0x0
	0x0000 00000 (<autogenerated>:1)	TEXT	"".(*T).M1(SB), DUPOK|WRAPPER|ABIInternal, $16-8
	...
	0x0024 00036 (<autogenerated>:1)	FUNCDATA	$5, "".(*T).M1.arginfo1(SB)
	0x0024 00036 (<autogenerated>:1)	FUNCDATA	$6, "".(*T).M1.argliveinfo(SB)
...
"".(*T).M2 STEXT dupok size=112 args=0x8 locals=0x8 funcid=0x15 align=0x0
	0x0000 00000 (<autogenerated>:1)	TEXT	"".(*T).M2(SB), DUPOK|WRAPPER|ABIInternal, $16-8
	0x0000 00000 (<autogenerated>:1)	MOVD	16(g), R16
	0x0004 00004 (<autogenerated>:1)	PCDATA	$0, $-2
	0x0004 00004 (<autogenerated>:1)	MOVD	RSP, R17
	0x0008 00008 (<autogenerated>:1)	CMP	R16, R17
	...
	0x0024 00036 (<autogenerated>:1)	FUNCDATA	ZR, gclocals·1a65e721a2ccc325b382662e7ffee780(SB)
	0x0024 00036 (<autogenerated>:1)	FUNCDATA	$1, gclocals·69c1753bd5f81501d95132d08af04464(SB)
	0x0024 00036 (<autogenerated>:1)	FUNCDATA	$5, "".(*T).M2.arginfo1(SB)
	0x0024 00036 (<autogenerated>:1)	FUNCDATA	$6, "".(*T).M2.argliveinfo(SB)
	0x0024 00036 (<autogenerated>:1)	PCDATA	$3, $1
	0x0024 00036 (<autogenerated>:1)	CBZ	R0, 52
	0x0028 00040 (<autogenerated>:1)	MOVD	-8(RSP), R29
	0x002c 00044 (<autogenerated>:1)	MOVD.P	16(RSP), R30
...
"".NonEmptyInterface.M2 STEXT dupok size=128 args=0x10 locals=0x18 funcid=0x15 align=0x0
	...
	rel 52+0 t=10 +0
	rel 80+4 t=9 runtime.morestack_noctxt+0
type..eq."".T STEXT dupok size=128 args=0x10 locals=0x28 funcid=0x0 align=0x0
	0x0000 00000 (<autogenerated>:1)	TEXT	type..eq."".T(SB), DUPOK|ABIInternal, $48-16
	0x0000 00000 (<autogenerated>:1)	MOVD	16(g), R16
	0x0004 00004 (<autogenerated>:1)	PCDATA	$0, $-2
	0x0004 00004 (<autogenerated>:1)	MOVD	RSP, R17
	0x0008 00008 (<autogenerated>:1)	CMP	R16, R17
	...
	0x001c 00028 (<autogenerated>:1)	FUNCDATA	$5, type..eq."".T.arginfo1(SB)
	0x001c 00028 (<autogenerated>:1)	FUNCDATA	$6, type..eq."".T.argliveinfo(SB)
